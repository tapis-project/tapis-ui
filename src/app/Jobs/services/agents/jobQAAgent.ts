...
function buildSystemPrompt(): string {
  return (
    'You are an expert assistant responsible for answering questions related to Tapis Jobs. ' +
    'You help users understand how to submit, monitor, and manage computational jobs in Tapis. ' +
    'Provide clear, accurate, and helpful answers based on your knowledge of Tapis Jobs. ' +
    'If you are unsure about something or need to provide more detailed information, ' +
    'please refer users to the official Tapis Jobs documentation at: ' +
        ...
        messages: [
          {
            ...
            role: 'assistant',
            content: 'Please ask a question about Tapis Jobs.',
          },
        ],
      };
    }
