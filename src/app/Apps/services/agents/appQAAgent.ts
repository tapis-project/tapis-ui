...
function buildSystemPrompt(): string {
  return (
    'You are an expert assistant responsible for answering questions related to Tapis Apps. ' +
    'You help users understand how to create, configure, and manage applications in Tapis. ' +
    'Provide clear, accurate, and helpful answers based on your knowledge of Tapis Apps. ' +
    'If you are unsure about something or need to provide more detailed information, ' +
    'please refer users to the official Tapis Apps documentation at: ' +
        ...
        messages: [
          {
            ...
            role: 'assistant',
            content: 'Please ask a question about Tapis Apps.',
          },
        ],
      };
    }
