...
import { Authenticator as AuthenticatorHooks, useTapisConfig } from '@tapis/tapisui-hooks';
...
const Login: React.FC = () => {
  ...
  if ( extension) {
    ...
    implicitAuthURL = implicitAuth.authorizationPath
      + `?client_id=${implicitAuth.clientId}&response_type=${implicitAuth.responseType}&redirect_uri=${encodeURIComponent("http://localhost:3000/#/oauth2")}`
    
    passwordAuth = (extension.getAuthByType("password") as boolean | undefined) || false
  }
    ...
    <div>
      ...
      <div className={styles["buttons"]}>
        ...
        {implicitAuthURL !== undefined && (
          <Button
            disabled={false}
            onClick={() => { window.location.replace(implicitAuthURL as string) }}
          >
