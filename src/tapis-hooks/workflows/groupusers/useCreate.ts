...
const useCreate = () => {
  ...
  const { mutate, isLoading, isError, isSuccess, data, error, reset } =
    useMutation<Workflows.RespResourceURL, Error, CreateGroupUserHookParams>(
      ...
      (params) => create({groupId: params.groupId, reqGroupUser: params.user}, basePath, jwt)
    );
  ...
  return {
    ...
    create: (
      ...
      options?: MutateOptions<Workflows.RespResourceURL, Error, CreateGroupUserHookParams>
    ) => {
