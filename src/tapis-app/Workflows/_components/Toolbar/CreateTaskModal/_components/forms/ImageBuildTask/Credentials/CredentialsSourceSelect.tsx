...
const CredentialsSourceSelect: React.FC<CredentialsSourceSelectProps> = ({type, scope}) => {
  const [ identityAsCreds, setIdentityAsCreds ] = useState<boolean|undefined>(undefined)
  return (
      ...
      <div className={styles["radio-button-container"]}>
        <label>
          <input
            ...
            onClick={() => {setIdentityAsCreds(false)}}
          /> Provide credentials
        </label>
      </div>
      <div className={styles["radio-button-container"]}>
        <label>
          <input
            ...
            defaultChecked={false}
            onClick={() => {setIdentityAsCreds(true)}}
