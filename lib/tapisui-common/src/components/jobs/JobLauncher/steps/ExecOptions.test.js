...
describe('ExecOptions step', function () {
    it('Shows default systems', function () { return __awaiter(void 0, void 0, void 0, function () {
        var getAllByTestId, execSystemId;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    getAllByTestId = renderComponent(_jsx(JobLauncherWizardRender, { jobSteps: [ExecOptionsStep] })).getAllByTestId;
                    return [4 /*yield*/, act(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                            return [2 /*return*/];
                        }); }); })];
                case 1:
                    _a.sent();
                    execSystemId = getAllByTestId('execSystemId')[0];
                    expect(execSystemId).toHaveValue('');
                    return [2 /*return*/];
            }
        });
    }); });
    it('Shows queue options if the job is a batch job', function () { return __awaiter(void 0, void 0, void 0, function () {
        var getAllByTestId, execSystemLogicalQueue;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    useJobLauncher.mockReturnValue({
                ...
                case 1:
                    _a.sent();
                    execSystemLogicalQueue = getAllByTestId('execSystemLogicalQueue')[0];
    ...
    it('Does not show systems that are not capable of batch jobs', function () { return __awaiter(void 0, void 0, void 0, function () {
        var tapisSystemNoQueues, getAllByTestId, execSystems;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    tapisSystemNoQueues = JSON.parse(JSON.stringify(tapisSystem));
                ...
                case 1:
                    _a.sent();
                    execSystems = getAllByTestId(/execSystemId-/);
