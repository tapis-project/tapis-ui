...
describe('FileInputsSummary step', function () {
    it('Shows fileInputs', function () {
        ...
        var getAllByText = renderComponent(_jsx(FileInputsSummary, {})).getAllByText;
        expect(getAllByText(/required-incomplete/).length).toEqual(1);
    });
    it('Shows fileInputs that are incomplete', function () {
        useJobLauncher.mockReturnValue({
            job: {
                fileInputs: [
                    {
    ...
    it('Shows fileInputs that are included by default', function () {
        useJobLauncher.mockReturnValue({
            job: {
                fileInputs: [],
            },
    ...
    it('Shows fileInputs that do not include underspecified required app inputs', function () {
